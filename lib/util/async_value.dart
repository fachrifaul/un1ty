...
// Copied from https://github.com/rrousselGit/river_pod/blob/master/packages/riverpod/lib/src/common.dart
...
throwErrorWithCombinedStackTrace(Object error, StackTrace stackTrace) {
  final chain = Chain([
    Trace.current(),
